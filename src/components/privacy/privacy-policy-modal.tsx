...
const Heading = ({ children }: { children: React.ReactNode }) => (
  <h2 className="text-[15px] font-medium mb-1 mt-4">{children}</h2>
)
        ...
        <AlertDialogDescription asChild>
          <div className="max-h-96 overflow-y-auto text-left">
            ...
            <Paragraph>
              ...
              caricato dagli utenti. I CV vengono elaborati esclusivamente per
              il tempo necessario a completare la valutazione e vengono
              eliminati subito dopo l'analisi.
            </Paragraph>
            ...
            <Paragraph>
              ...
              , e i dati non vengono memorizzati permanentemente. L'uso dei dati
              è limitato esclusivamente all'elaborazione richiesta dal servizio.
              Puoi leggere le{" "}
              <a
                target="_blank"
              ...
              per ulteriori dettagli sulla gestione dei dati tramite le loro
              API.
            </Paragraph>
            ...
            <Paragraph>
              ...
              sono condivisi con terze parti, eccetto OpenAI, che esegue
              l'analisi del contenuto. I dati vengono eliminati immediatamente
              dopo la valutazione e non vengono conservati per utilizzi futuri.
            </Paragraph>

            <Heading>5. Uso del servizio</Heading>

            <Paragraph>
              Utilizzando Pentametro, accetti i termini di questa privacy
              policy. Ti invitiamo a rimuovere eventuali dati personali che non
              desideri condividere prima di caricare il CV, soprattutto se non
              strettamente necessari per la valutazione.
            </Paragraph>

            <Heading>6. Modifiche alla privacy policy</Heading>

            <Paragraph>
              Pentametro si riserva il diritto di aggiornare questa Privacy
              Policy in qualsiasi momento. Eventuali modifiche verranno
              comunicate attraverso il sito web.
            </Paragraph>
          </div>
